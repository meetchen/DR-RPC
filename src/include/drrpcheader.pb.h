...
#ifndef GOOGLE_PROTOBUF_INCLUDED_drrpcheader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_drrpcheader_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_drrpcheader_2eproto
...
struct TableStruct_drrpcheader_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_drrpcheader_2eproto;
namespace duan {
class RpcHeader;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::duan::RpcHeader* Arena::CreateMaybeMessage<::duan::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace duan {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:duan.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_drrpcheader_2eproto);
    return ::descriptor_table_drrpcheader_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline const std::string& RpcHeader::servicename() const {
  // @@protoc_insertion_point(field_get:duan.RpcHeader.serviceName)
  return _internal_servicename();
}
inline void RpcHeader::set_servicename(const std::string& value) {
  _internal_set_servicename(value);
  // @@protoc_insertion_point(field_set:duan.RpcHeader.serviceName)
}
inline std::string* RpcHeader::mutable_servicename() {
  // @@protoc_insertion_point(field_mutable:duan.RpcHeader.serviceName)
...
inline void RpcHeader::set_servicename(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:duan.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:duan.RpcHeader.serviceName)
}
inline void RpcHeader::set_servicename(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:duan.RpcHeader.serviceName)
}
...
inline std::string* RpcHeader::release_servicename() {
  // @@protoc_insertion_point(field_release:duan.RpcHeader.serviceName)
...
inline void RpcHeader::set_allocated_servicename(std::string* servicename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:duan.RpcHeader.serviceName)
}
...
inline const std::string& RpcHeader::methodname() const {
  // @@protoc_insertion_point(field_get:duan.RpcHeader.methodName)
  return _internal_methodname();
}
inline void RpcHeader::set_methodname(const std::string& value) {
  _internal_set_methodname(value);
  // @@protoc_insertion_point(field_set:duan.RpcHeader.methodName)
}
inline std::string* RpcHeader::mutable_methodname() {
  // @@protoc_insertion_point(field_mutable:duan.RpcHeader.methodName)
...
inline void RpcHeader::set_methodname(std::string&& value) {
  ...
  methodname_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:duan.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:duan.RpcHeader.methodName)
}
inline void RpcHeader::set_methodname(const void* value, size_t size) {
  ...
  methodname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:duan.RpcHeader.methodName)
}
...
inline std::string* RpcHeader::release_methodname() {
  // @@protoc_insertion_point(field_release:duan.RpcHeader.methodName)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_drrpcheader_2eproto
